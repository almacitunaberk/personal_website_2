    ...
    if ((l.originalEvent && (l = l.originalEvent), i.isTouched)) {
      if (!i.isTouchEvent || 'touchmove' === l.type) {
        ...
        if (!a.allowTouchMove)
          return (
            (a.allowClick = !1),
            void (i.isTouched && (C(n, { startX: p, startY: c, currentX: p, currentY: c }), (i.touchStartTime = x())))
          );
            ...
            for (
              ...
              if ('none' !== O.css('display')) {
                if ('auto' === i.slidesPerView) {
                  ...
                  if (
                    (Y && (O[0].style.transform = 'none'), R && (O[0].style.webkitTransform = 'none'), i.roundLengths)
                  )
        ...
        (r.mount = function (e) {
          ...
          return (
            ...
            C(t, {
              ...
              rtlTranslate:
                'horizontal' === t.params.direction && ('rtl' === e.dir.toLowerCase() || 'rtl' === i.css('direction')),
      ...
      setTranslate: function () {
        ...
        for (var v = 0; v < s.length; v += 1) {
          ...
          var S =
            ...
            'px)';
          if (
            (y <= 1 && y > -1 && ((h = 90 * g + 90 * y), o && (h = 90 * -g - 90 * y)), f.transform(S), p.slideShadows)
          ) {
            var C = c ? f.find('.swiper-slide-shadow-left') : f.find('.swiper-slide-shadow-top'),
              M = c ? f.find('.swiper-slide-shadow-right') : f.find('.swiper-slide-shadow-bottom');
            0 === C.length &&
              ((C = m('<div class="swiper-slide-shadow-' + (c ? 'left' : 'top') + '"></div>')), f.append(C)),
              0 === M.length &&
                ((M = m('<div class="swiper-slide-shadow-' + (c ? 'right' : 'bottom') + '"></div>')), f.append(M)),
        ...
        for (var e = this, t = e.slides, a = e.rtlTranslate, i = 0; i < t.length; i += 1) {
          ...
          if (
            ...
            0 === p.length &&
              ...
              s.append(p)),
              0 === c.length &&
                ((c = m('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? 'right' : 'bottom') + '"></div>')),
                s.append(c)),
      ...
      setTranslate: function () {
        for (
          ...
          if ((h.transform(S), (h[0].style.zIndex = 1 - Math.abs(Math.round(f))), r.slideShadows)) {
            ...
            0 === C.length &&
              ((C = m('<div class="swiper-slide-shadow-' + (n ? 'left' : 'top') + '"></div>')), h.append(C)),
              0 === M.length &&
          ...
          t.swiper instanceof a
            ...
            : S(t.swiper) &&
              ((e.thumbs.swiper = new a(
                C({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 })
              )),
